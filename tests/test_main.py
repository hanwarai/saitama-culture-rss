...
def test_show_to_item_links_to_detail_page(show_full: dict[str, Any]) -> None:
    ...
    assert item["unique_id"] == "https://p-ticket.jp/saitama-culture/show/bc260501/schedule"
    assert item["link"] == "https://p-ticket.jp/saitama-culture/show/bc260501/schedule"
...
def test_build_feed_uses_absolute_url_as_entry_id(show_full: dict[str, Any]) -> None:
    ...
    assert "<id>https://p-ticket.jp/saitama-culture/show/bc260501/schedule</id>" in xml
...
def test_build_feed_skips_invalid_shows(show_full: dict[str, Any]) -> None:
    ...
    assert (
        feed.items[0]["unique_id"] == "https://p-ticket.jp/saitama-culture/show/bc260501/schedule"
    )
...
def test_main_writes_feed_xml(
    ...
    assert "https://p-ticket.jp/saitama-culture/show/bc260501/schedule" in body
